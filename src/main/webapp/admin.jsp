...
<%@ page
	import="cgg.ecommerce.helpers.*, cgg.ecommerce.dao.CategoryDao,cgg.ecommerce.dao.UserDao,cgg.ecommerce.dao.ProductDao, cgg.ecommerce.entities.*,java.util.List"%>
<%
					...
					<form action="addUserServlet" method="post">
						<div class="mb-3">
							<label for="name" class="form-label fw-bold">Enter
								Username</label> <input type="hidden" name="operation" value="adduser">
